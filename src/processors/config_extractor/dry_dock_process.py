...
def drydock(dry_dock_period,eval_data_period,imo,performance_type):
    ...
    #     base_dataframe = pandas.read_csv("src/processors/config_extractor/welland_interventioncompletedata_dateschanged.csv")
    # else:
    if performance_type == 'maintainance_trigger':
        base_dataframe = pandas.read_csv("src/processors/config_extractor/welland_intervention_0.95stw.csv")
    else:
        base_dataframe = pandas.read_csv("src/processors/config_extractor/welland_intervention_1.05stw.csv")
    newdatearray=[]
    ...
    group=[
        {
            "identifier": 'pwr_pred_eval_data',
            "short_name": "Power based on evaluation data",
            "block_number": 1
        },
        {
            "identifier": 'pwr_second_pred_ref_data',
        ...
        # },
        {
            "identifier": 'main_fuel_per_dst_pred_eval_data',
            "short_name": "Fuel per Distance based on evaluation data",
            "block_number": 2
        },
        {
            "identifier": 'speed_stw_calc_fourth_pred_eval_data',
        ...
        # },
        {
            "identifier": 'main_fuel_per_dst_second_pred_ref_data',
            "short_name": "Fuel per Distance based on reference data",
            "block_number": 2
        },
        {
            "identifier": 'speed_stw_calc_third_pred_ref_data',
            "short_name": "Speed Through Water based on reference data",
            "block_number": 3
        },
        {
            "identifier": 'speed_stw_calc_loss',
            "short_name": "Speed Through Water - Loss(%) Now" if performance_type == 'maintainance_trigger' else "Speed Through Water - Gain(%) Now",
            "block_number": 4
        },
        {
            "identifier": 'pwr_loss',
            "short_name": "Power Rise(%) Now" if performance_type == 'maintainance_trigger' else "Power Drop(%) Now",
            "block_number": 5
        },
        # {
        ...
        # },
        {
            "identifier": 'main_fuel_per_dst_rise',
            "short_name": "Fuel per Distance - Rise Now(%)" if performance_type == 'maintainance_trigger' else "Fuel per Distance - Drop Now(%)",
            "block_number": 6
        },
        {
            "identifier": 'pwr_loss_avg',
            "short_name": "Power Rise(%) Average" if performance_type == 'maintainance_trigger' else "Power Drop(%) Average",
            "block_number": 5
        },
        # {
        ...
        # },
        {
            "identifier": 'main_fuel_per_dst_rise_avg',
            "short_name": "Fuel per Distance - Rise Average(%)" if performance_type == 'maintainance_trigger' else "Fuel per Distance - Drop Average(%)",
            "block_number": 6
        },
        {
            "identifier": 'speed_stw_calc_loss_avg',
            "short_name": "Speed Through Water Loss(%) Average" if performance_type == 'maintainance_trigger' else "Speed Through Water - Gain(%) Average",
            "block_number": 4
        }
    ]
    ...
    order_of_loss_avg = [
        ...
        'main_fuel_per_dst_rise_avg',
        'pwr_loss',
        'speed_stw_calc_loss',
        'main_fuel_per_dst_rise'
    ]
    ...
    for column in eval_data.columns:
        if column == 'rep_dt':
            ...
            if (column == 'pwr_pred_eval_data' or column == 'pwr_second_pred_ref_data' or column == 'main_fuel_per_dst_pred_eval_data' or
            column == 'speed_stw_calc_fourth_pred_eval_data' or column == 'speed_stw_calc_third_pred_ref_data' or
            column == 'main_fuel_per_dst_second_pred_ref_data' or column == 'speed_stw_calc_loss' or column == 'main_fuel_per_dst_rise'
            or column == 'pwr_loss' or column == 'pwr_loss_avg' or column == 'main_fuel_per_dst_rise_avg' or column == 'speed_stw_calc_loss_avg'):
    ...
    subgroup_names = [
        ...
        'Fuel per Distance',
        'Speed Through Water',
        'Speed Through Water Loss/Gain',
        'Power Loss/Gain',
        'Fuel per Distance Drop/Rise'
    ]
    
    
    return eval_dict, short_names, group, chart_height, temp_ref_data_period, temp_eval_data_period, order_of_loss_avg, shapes, subgroup_names
