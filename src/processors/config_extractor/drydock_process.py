...
def drydock(dry_dock_period,eval_data_period,imo):
    ...
    group=[
        {
            "identifier": 'pwr_pred',
            "short_name": short_names['pwr'] + " based on evaluation data",
            "block_number": 1
        },
        {
            "identifier": 'pwr_second_pred',
            "short_name": short_names['pwr'] + " based on reference data",
            "block_number": 1
        },
        {
        ...
        },
        {
            ...
            "short_name": short_names['main_fuel_per_dst'] + " based on evaluation data",
            "block_number": 3
        },
        {
            "identifier": 'speed_stw_calc_pred',
            "short_name": short_names['speed_stw_calc'] + " based on evaluation data",
            "block_number": 4
        },
        {
        ...
        },
        {
            ...
            "short_name": short_names['main_fuel_per_dst'] + " based on reference data",
            "block_number": 3
        },
        {
            "identifier": 'speed_stw_calc_third_pred',
            "short_name": short_names['speed_stw_calc'] + " based on reference data",
            "block_number": 4
        },
        {
            "identifier": 'speed_stw_calc_loss',
            "short_name": short_names['speed_stw_calc'] + " Loss",
            "block_number": 5
        },
        {
            "identifier": 'pwr_loss',
            "short_name": short_names['pwr'] + " Loss",
            "block_number": 5
        },
        # {
        ...
        # },
        {
            ...
            "short_name": short_names['main_fuel_per_dst'] + " Loss",
            "block_number": 5
        },
        {
            "identifier": 'pwr_loss_avg',
            "short_name": short_names['pwr'] + " Average",
            "block_number": 5
        },
        # {
        ...
        # },
        {
            ...
            "short_name": short_names['main_fuel_per_dst'] + " Average",
            "block_number": 5
        },
        {
            "identifier": 'speed_stw_calc_loss_avg',
            "short_name": short_names['speed_stw_calc'] + " Average",
            "block_number": 5
        }
    ]
    ...
    for column in eval_data.columns:
        if column == 'rep_dt':
            ...
            if column == 'pwr_pred' or column == 'pwr_second_pred' or column == 'app_slip_pred' or column == 'main_fuel_per_dst_pred' or column == 'speed_stw_calc_pred' or column == 'app_slip_third_pred' or column == 'speed_stw_calc_third_pred' or column == 'main_fuel_per_dst_third_pred' or column == 'speed_stw_calc_loss' or column == 'main_fuel_per_dst_loss' or column == 'pwr_loss' or column == 'app_slip_loss' or column == 'pwr_loss_avg' or column == 'app_slip_loss_avg' or column == 'main_fuel_per_dst_loss_avg' or column == 'speed_stw_calc_loss_avg':
                temp_list=list(map(configuration.makeDecimal, eval_data[column]))
                eval_dict[column] = temp_list
    
    
    return eval_dict, short_names, group, chart_height
