        ...
        if self.fuel!=None and self.eng!=None:
            ...
            try :
                ...
                if ship_imo==self.imo:
                    ...
                    temp_fuel1=temp_fuel1.drop([identifier_mapping["vsl_load"]],axis=1)
                    ...
                    temp_eng1=temp_eng1.drop([identifier_mapping["vsl_load"]],axis=1)
...
# obj=DailyInsert('F:\Afzal_cs\Internship\Aggregated_Data_9591301_Cook_afzal.xlsx',9591302)
# obj.connect()
