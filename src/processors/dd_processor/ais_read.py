...
def job():
    ...
    return_dict['position_received'] = None
    return_dict['heading'] = None
    return_dict = get_route("https://zylalabs.com/api/1835/vessel+information+and+route+tracking+api/1499/get+route?imoCode=9205926", return_dict)
    return_dict = get_current_position('https://zylalabs.com/api/1835/vessel+information+and+route+tracking+api/1575/get+current+position?imoCode=9205926', return_dict)
