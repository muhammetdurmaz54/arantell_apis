...
MONGODB_URI = "mongodb+srv://shared:ooAvesvZ9l5oTyQd@cluster0.dqgbzdu.mongodb.net/test"
client = MongoClient(MONGODB_URI)

db=client.get_database("aranti")
database = db

# shared_uri="mongodb+srv://shared:ooAvesvZ9l5oTyQd@cluster0.dqgbzdu.mongodb.net/test"
# shared_client = MongoClient(shared_uri)

# shared_db=shared_client.get_database("aranti")
